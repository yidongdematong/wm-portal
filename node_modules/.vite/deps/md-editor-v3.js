...
import {
  ...
  provide,
  watch
} from "./chunk-C7GDZLZW.js";
import {
  reactive,
  ref,
  toRef
} from "./chunk-YKSXQ25H.js";
...
var prefix = "md";
var iconfontUrl = "https://at.alicdn.com/t/font_2605852_pqekijay2ij.js";
var cdnBase = "https://cdnjs.cloudflare.com/ajax/libs";
var highlightUrl = `${cdnBase}/highlight.js/11.5.1/highlight.min.js`;
var prettierUrl = {
...
var screenfullUrl = `${cdnBase}/screenfull.js/5.1.0/screenfull.min.js`;
var allToolbar = [
  "bold",
  "underline",
  "italic",
...
var mermaidUrl = `${cdnBase}/mermaid/8.13.5/mermaid.min.js`;
var katexUrl = {
...
var bus = new Bus();
var setPosition = (tarDom, startPos = 0, endPos = startPos) => {
...
var insert = (dom, tarValue, params) => {
...
var generateCodeRowNumber = (code) => {
  if (!code.trim()) {
    return code;
  }
...
var updateHandler = debounce((id, attr, value) => {
  const ele = document.getElementById(id);
  if (ele) {
    ele.setAttribute(attr, value);
  }
}, 10);
var useKeyBoard = (props, context) => {
...
var directive2flag = (direct, selectedText = "", inputArea, params) => {
  var _a, _b, _c, _d, _e;
  let targetValue = "";
...
var useHistory = (props, textAreaRef, completeStatus) => {
  var _a, _b;
  const previewOnly = inject("previewOnly");
...
var useMarked = (props, mermaidData) => {
  var _a, _b, _c;
  const {
    markedRenderer,
    markedExtensions,
...
var useAutoScroll = (props, html, textAreaRef, previewRef, htmlRef) => {
  const previewOnly = inject("previewOnly");
  const ult = inject("usedLanguageText");
  const editorId = inject("editorId");
  let clearScrollAuto = () => {
...
var useAutoGenrator = (props, textAreaRef) => {
  const previewOnly = inject("previewOnly");
...
var usePasteUpload = (textAreaRef) => {
  const editorId = inject("editorId");
  const previewOnly = inject("previewOnly");
...
// dep:md-editor-v3
var md_editor_v3_default = Editor;
export {
  md_editor_v3_default as default
};
